...
--
--   function  : public.approve_redemption_atomic(p_redemption_id uuid, p_user_id uuid, p_user_email text)
--   captured  : 2026-09-17 05:21:02.267226+00 (SELECT pg_get_functiondef(oid))
--   md5       : f61e90c9e9bc92791d7b6662004d4fb1
--   length    : 9077 bytes
--
...
--    WHERE n.nspname = 'public' AND p.proname = 'approve_redemption_atomic';
--
