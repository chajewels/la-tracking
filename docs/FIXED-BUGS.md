...
Observed in Gmail on CJ-W-900013's plan-created email: Total, Deposit, Term, account number and account holder all truncated mid-value — a customer could read neither the amount owed nor the account number to transfer to. Raised earlier on order-confirmation and not fixed then.
