...
- Status codes: 0 = new, 1 = submitted, 6 = cancelled. The POS displayed "waiting for pickup" for status 1, so status_name is the reliable label, not an inference from the code.
