...
- 2026-06-12: Demand Map gained Order Placed filter (applies to all
  ...
  inquiries)
- Sales Commission module (/commissions) live — sales_log (735 rows incl Dec 2025)/commission_agents/commission_splits, generalized merge_groups role merging, GAS algorithm replicated client-side (winner-take-all, one role per agent, amount tiebreaker), sheet retired to backup.
