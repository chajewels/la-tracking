...
export const portalEn = {
  ...
  loyalty: {
    ...
    // Activity list labels (Bug #283) — customers never see ledger notes
    activityJoined: 'Joined Cha Jewels Circle',
    activityTier: 'Tier updated',
    activityTierNamed: 'Tier updated to {{tier}}',
    activitySourceMembership: 'Membership',
    activityTypeEarned: 'Points earned',
    activityTypeBonus: 'Bonus points',
    activityTypeBirthday: 'Birthday bonus',
    activityTypeRedeemed: 'Points redeemed',
    activityTypeExpired: 'Points expired',
    activityTypeAdjusted: 'Points adjustment',
    activityTypeRefunded: 'Points returned',
    activityTypeRevoked: 'Points reversed',
    activityTypeOther: 'Points update',
    // RedemptionForm
