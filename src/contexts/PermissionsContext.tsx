...
const NAV_PATHS = ['/', '/accounts', '/customers', '/monitoring', '/reminders', '/collections', '/finance', '/payment-submissions', '/waivers', '/analytics', '/admin-audit', '/system-audit', '/settings', '/admin/payment-vault'];
