...
const ProofsSearchBar = memo(function ProofsSearchBar({ onSearch }: { onSearch: (v: string) => void }) {
  return (
    <div className="relative w-full max-w-xs">
      ...
      <input
        className="flex h-9 w-full rounded-md border border-input bg-card px-3 py-2 pl-8 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
