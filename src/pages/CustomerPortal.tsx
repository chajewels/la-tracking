          ...
          <>
            ...
            {payableAccounts.length > 1 && (
              ...
              >
                ...
                {'Split a payment across accounts'}
              </button>
            )}
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                <SelectTrigger className="w-full sm:w-[150px] text-foreground" aria-label={'Status'}>
              ...
              <Select value={sortBy} onValueChange={setSortBy}>
                <SelectTrigger className="w-full sm:w-[150px] text-foreground" aria-label={'Sort'}>
              ...
              <div style={{flex:1}}>
                ...
                {(() => {
                  const daysSinceForfeiture = account.forfeited_at
                    ...
                    : 0;
                  const windowOpen = !account.forfeited_at || daysSinceForfeiture <= 7;
