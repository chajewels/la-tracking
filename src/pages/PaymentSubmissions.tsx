...
export default function PaymentSubmissions() {
  ...
  return (
    <AppLayout>
      ...
      {!!underpaymentModal && <div className="fixed inset-0 bg-black/50" style={{ zIndex: 70 }} />}
      ...
      {overpaymentModal && <div className="fixed inset-0 bg-black/60 pointer-events-auto" style={{ zIndex: 9998 }} />}
