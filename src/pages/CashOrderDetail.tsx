      ...
      <div className="animate-fade-in space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-foreground font-display">Cash Order Detail</h1>
        ...
        <div className="rounded-xl border border-border bg-card p-12 text-center">
          ...
          <p className="text-sm text-muted-foreground">Cash order detail view will be added in the next step.</p>
        </div>
      </div>
    </AppLayout>
  );
