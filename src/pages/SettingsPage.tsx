...
const ROLE_PERMISSIONS: Record<string, { label: string; description: string; permissions: string[] }> = {
  admin: {
    ...
    permissions: [
      ...
      'Create, edit, delete and manage all layaway accounts',
      'Record, confirm, void and restore payments',
      'Bulk payment import',
      'Approve or reject penalty waivers',
      'Add penalties and override penalty caps',
      'Manage team members and assign roles',
      'Configure system settings and feature toggles',
      'View audit logs and payment vault',
      'Access all analytics, finance, and collections',
      'Manage promotions and announcements',
      'Send reminders to customers',
      'Grant per-member permission overrides',
    ],
  },
  staff: {
    label: 'Staff',
    description: 'Day-to-day account management and customer operations.',
    permissions: [
      'Create, view and manage layaway accounts',
      'Record payments and view schedules',
      'Add penalties to overdue accounts',
      'Request penalty waivers (cannot approve)',
      'Add services to accounts',
      'View and manage customers',
      'Submit payment proofs on behalf of customers',
      'Send reminders to customers',
      'Manage promotions and announcements',
  ...
  finance: {
    label: 'Finance',
    description: 'Financial oversight with payment approval authority.',
    permissions: [
      'View all layaway accounts and payment history',
      'Confirm, reject or request clarification on payment submissions',
      'Approve or reject penalty waivers',
      'View financial documentation and waivers',
      'Bulk payment import',
      'Access finance dashboard, analytics and collections',
      'View payment vault',
  ...
  csr: {
    ...
    description: 'Customer-facing role focused on monitoring and reminders.',
    permissions: [
      'View layaway accounts and payment schedules',
      'View customer information',
      'Monitor overdue and at-risk accounts',
      'Send payment reminders via email and Messenger',
      'View CSR monitoring dashboard',
