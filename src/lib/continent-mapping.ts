/** Maps country names to continents for the Regional Overview grouping. */

const CONTINENT_MAP: Record<string, string> = {
  // Asia
  "Japan": "Asia", "Philippines": "Asia", "Afghanistan": "Asia", "Armenia": "Asia", "Azerbaijan": "Asia",
  ...
  "Iran": "Asia", "Iraq": "Asia", "Israel": "Asia", "Jordan": "Asia", "Kazakhstan": "Asia",
  ...
  "Oman": "Asia", "Pakistan": "Asia", "Palestine": "Asia", "Qatar": "Asia", "Saudi Arabia": "Asia",
  "Singapore": "Asia", "South Korea": "Asia", "Sri Lanka": "Asia", "Syria": "Asia", "Taiwan": "Asia",
  "Tajikistan": "Asia", "Thailand": "Asia", "Turkmenistan": "Asia", "United Arab Emirates": "Asia",
  "Uzbekistan": "Asia", "Vietnam": "Asia", "Yemen": "Asia", "East Timor": "Asia",
...
/** Returns the continent for a given country/location string. Defaults to 'Uncategorized'. */
export function getContinent(location: string | null | undefined): string {
  if (!location || location.trim() === '') return 'Asia'; // default empty = Japan
  const loc = location.trim();
  if (loc === 'Japan' || loc === 'Philippines') return 'Asia';
  return CONTINENT_MAP[loc] || 'Uncategorized';
}

/** Continent display order */
export const CONTINENT_ORDER = ['Asia', 'Europe', 'North America', 'South America', 'Africa', 'Oceania', 'Uncategorized'];

/** Emoji icons for continents */
