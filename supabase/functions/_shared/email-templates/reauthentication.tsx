...
export const ReauthenticationEmail = ({ token }: ReauthenticationEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your verification code for Cha Jewels</Preview>
    <Body style={main}>
...
const codeStyle = { fontFamily: 'Courier, monospace', fontSize: '24px', fontWeight: 'bold' as const, color: '#b8860b', margin: '0 0 30px', letterSpacing: '4px' }
