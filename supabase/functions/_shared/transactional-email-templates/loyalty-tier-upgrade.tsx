...
const upgradeBox = { background: 'linear-gradient(135deg, #fff4dc 0%, #fef3c7 50%, #fff4dc 100%)', border: '2px solid #C9A227', borderRadius: '12px', padding: '20px', margin: '8px 24px 16px', textAlign: 'center' as const }
