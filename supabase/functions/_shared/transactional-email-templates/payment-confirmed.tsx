...
const PaymentConfirmedEmail = ({
  ...
  return (
    <Html lang="en" dir="ltr">
      <Head />
      <Preview>Payment confirmed for INV #{invoiceNumber}</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            ...
            <strong>INV #{invoiceNumber}</strong> has been confirmed. Thank you
            for your continued trust in {SITE_NAME}! 🧡
          </Text>
