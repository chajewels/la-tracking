...
interface Props {
  ...
  oldTier?: string
  newTier?: string
  reason: 'account_reactivated' | 'payment_restored' | 'manual_restore'
...
const REASON_COPY: Record<Props['reason'], string> = {
  account_reactivated:
    'Your account has been reactivated, restoring your loyalty progress and tier benefits.',
  payment_restored:
    'A previously voided payment has been restored, bringing back your loyalty progress.',
  manual_restore:
    'Your loyalty progress has been restored by our team.',
}

const LoyaltyTierRestoredEmail = ({
  ...
  return (
    <Html lang="en" dir="ltr">
      <Head />
      <Preview>Your loyalty tier has been restored</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={reassureBox}>
            <Text style={reassureTitle}>Your benefits are active again</Text>
            <Text style={reassureBalance}>{fmt(remainingPoints)} pts available</Text>
            <Text style={reassureMultiplier}>{newMultiplier}× points earning rate restored</Text>
          </Section>

          <Text style={closing}>
            Thank you for being part of Cha Jewels.
          </Text>
...
export const template = {
  component: LoyaltyTierRestoredEmail,
  subject: (data: Record<string, any>) =>
    `Your loyalty tier has been restored, ${data.customerName || 'Valued Customer'}`,
  displayName: 'Loyalty Tier Restored',
  previewData: {
