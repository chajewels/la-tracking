...
-- ============================================================ VERIFICATION
--   SELECT sku, karat, metals FROM public.website_products ORDER BY sku;
--   -- every row: cardinality(metals) >= 1 AND karat::text = metals[1]
--   SELECT enum_range(NULL::public.website_product_karat);
--   -- includes K24, 750, 18K, PT850, PM, PM900
